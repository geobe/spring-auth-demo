...
import de.geobe.spring.auth.filter.JWTAuthenticationFilter
import de.geobe.spring.auth.filter.JWTLoginFilter
import de.geobe.spring.auth.filter.JWTLogoutSuccessHandler
