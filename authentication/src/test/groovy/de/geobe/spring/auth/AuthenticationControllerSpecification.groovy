...
import de.geobe.spring.auth.service.AdminTestService
import de.geobe.spring.auth.service.AuthenticationTestService
...
//    @Ignore
    def "info should be retrieved from server"() {
        ...
        reply == '{hurz=42, burz=26, auth=-7, quack={message=never, answer=perhaps}}'
    }
